...
5. Nesse arquivo, substitua ``xxxxxxxxxx`` pelos nomes dos certificados correspondentes.
...
```
17. Novamente compacte todos arquivos e diretórios menos o diretório oculto ``.git``;
